...
export default class OrdererStatus3 extends Component {
    ...
    return(
        ...
        <Image style={styles.image} source={require('../assets/images/status3.png')}>
        ...
        <View style={{ flex: 1, marginTop: 12, backgroundColor: '#FFFFFF' }}>
                ...
                <TouchableOpacity style={styles.checkoutButton} onPress={() => this.props.navigation.navigate('Home')} >
