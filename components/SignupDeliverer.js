...
function SignupDeliverer ({navigation}){
    return(
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={()=> navigation.navigate('Signup')} style={styles.button3}>
            ...
            <TouchableOpacity onPress={()=> navigation.navigate('SignupDeliverer')} style={styles.button} marginTop={-200}>
            ...
            <View>
            <Text style={styles.titlesTitle2}>
                Sign up
            </Text>
            ...
            <View style={styles.orientation}>
              ...
              <TouchableOpacity style={styles.signup} onPress={() => navigation.navigate('LoginDeliverer')}>
