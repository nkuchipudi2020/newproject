...
export default class DelivererStatus3 extends Component {
    ...
    return(
        ...
        <Image style={styles.image} source={require('../assets/images/status2.png')}>
        ...
        <Text style={styles.subtitle}>
            Delivery is complete! You will receiive your pay in your bank account soon.
        </Text>
        ...
        <View style={{ flex: 1, marginTop: 12, backgroundColor: '#FFFFFF' }}>
                ...
                <TouchableOpacity style={styles.checkoutButton} onPress={() => this.props.navigation.navigate('DelivererHome')} >
