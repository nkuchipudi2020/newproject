    ...
    return(
        <View style={styles.container}>
           <Text style = {styles.titlesTitle}>Choose account type</Text>
              ...
              <TouchableOpacity onPress={()=> navigation.navigate('Login')} style={styles.button3}>
           ...
           <Text style={styles.noAcc}>
             ...
             <TouchableOpacity>
               <Text style={styles.signup} onPress={()=>navigation.navigate('SignupDeliverer')}>
                 Sign up
               </Text>
             </TouchableOpacity>
             <TouchableOpacity style={styles.button2} onPress={()=>navigation.navigate('DelivererHome')}>
